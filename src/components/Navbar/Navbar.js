        ...
        <nav className="navbar navbar-expand-lg fixed-top px-5">
            ...
            <div className="collapse navbar-collapse d-block " id="navbarNav">
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link mr-3 font-width-bold btn btn-outline-warning" to="/">Destination</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link mr-3 font-width-bold btn btn-outline-warning" to="/">Cotact</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link mr-3 font-width-bold btn btn-outline-warning" to="/">Blog</Link>
                    </li>
                    {loggedInUser.isSignIn ?
                        <li className="nav-item">
